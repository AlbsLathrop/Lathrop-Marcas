      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="relative bg-white/5 border border-brass rounded-xl p-6 md:p-12">
            ...
            <p className="text-base md:text-lg text-white/80 mb-2 md:mb-4 text-left leading-relaxed">
            ...
            <p className="text-sm text-white/50 mb-2 md:mb-4 text-left leading-relaxed">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 md:px-10 py-1 md:py- min-h-11 md:min-h-auto bg-azure text-white rounded-[8px] font-semibold text-base transition-all duration-200 hover:bg-opacity-90 hover:-translate-y-0.5"
            >
              Empecemos →
            </a>
          </div>
