      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center space-y-8">
        ...
        <div className="space-y-4 pt-4">
          <a
            ...
            className="inline-flex items-center gap-2 px-8 md:px-12 py-4 md:py-5 bg-white text-navy rounded-lg font-semibold text-base md:text-lg hover:bg-gray-100 transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
